(function(global){
  ...
  const M = {
    ja: {
      ...
      'advanced.open':'シーンを調整','footer.note':'Easy Studioは本文を作るだけ。再生は共通Scene Player Coreが担当します。',
      ...
      'scene.font':'このSceneの書体','font.inherit':'作品設定を使う',
    ...
    en: {
      ...
      'advanced.open':'Adjust Scenes','footer.note':'Easy Studio only authors the content. Shared Scene Player Core handles playback.',
      ...
      'scene.font':'Typeface for this Scene','font.inherit':'Use work setting',
