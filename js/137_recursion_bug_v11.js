/* 137_recursion_bug_v11.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v1.1 / DEVELOPER ACCESS FIX
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV11"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV11";
    st.textContent=`
  ...
  window.MEGANE_RECURSION_BUG={version:"v1.1-developer-access-fix",open:open,close:close};
})();
