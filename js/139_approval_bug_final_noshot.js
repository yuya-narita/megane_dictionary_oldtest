/* 139_approval_bug_final_noshot.js
...
(function(){
  ...
  var VERSION="final-1.0-no-screenshot";
  ...
  function ensureStyle(){
    if(document.getElementById("approvalBugStyleFinalNoShot"))return;
    var s=document.createElement("style");
    s.id="approvalBugStyleFinalNoShot";
    s.textContent=`
