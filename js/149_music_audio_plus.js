...
(function(){
  ...
  function injectStyle(){
    ...
    st.textContent=
      ...
      ".music-album-edit112{position:fixed;inset:calc(58px + env(safe-area-inset-top)) 10px calc(62px + env(safe-area-inset-bottom));z-index:2147483020;overflow:hidden;padding:13px 14px 12px;border-radius:27px;background:rgba(24,15,26,.992);border:1px solid rgba(255,255,255,.16);box-shadow:0 24px 70px rgba(0,0,0,.66);color:#fff;display:flex;flex-direction:column;box-sizing:border-box}.music-album-edit112 .head112{display:flex;align-items:center;justify-content:space-between;margin-bottom:7px;min-height:38px}.music-album-edit112 .head112 strong{font-size:20px}.music-album-edit112 .head112 button{width:38px;height:38px;border:0;background:transparent;color:#fff;font-size:27px;padding:0}.music-album-edit112 .art112{display:grid;grid-template-columns:82px minmax(0,1fr);gap:11px;align-items:center}.music-album-edit112 .art112 img{width:82px;height:82px;border-radius:15px;object-fit:cover;background:#100b12}.music-album-edit112 .art112 div{display:grid;grid-template-columns:1fr 1fr;gap:7px}.music-album-edit112 button{border:0;border-radius:13px;min-height:38px;padding:8px 10px;background:rgba(255,255,255,.08);color:#fff;font-weight:900}.music-album-edit112 .title112{display:grid;gap:5px;margin:9px 0 6px;color:rgba(255,255,255,.68);font-size:11px;font-weight:900}.music-album-edit112 .title112 input{width:100%;box-sizing:border-box;border:1px solid rgba(255,255,255,.18);border-radius:13px;background:rgba(255,255,255,.07);color:#fff;font-size:15px;padding:10px 12px;outline:none}.music-album-edit112 .title-meta1122{display:flex;justify-content:space-between;gap:10px;margin-top:0;font-size:10px}.music-album-edit112 .title-count1122{color:rgba(255,255,255,.46);white-space:nowrap}.music-album-edit112 .title-warn1122{color:rgba(255,232,138,.78);opacity:0;transition:opacity .15s}.music-album-edit112 .title-warn1122.show{opacity:1}.music-album-edit112 .section112{display:flex;flex-direction:column;min-height:0;flex:1}.music-album-edit112 .section112>strong{display:block;margin:5px 0 4px;flex:0 0 auto;font-size:16px}.music-album-edit112 .trackpick112{min-height:270px;overflow:auto;-webkit-overflow-scrolling:touch;padding-right:2px;overscroll-behavior:contain;border-top:1px solid rgba(255,255,255,.04)}.music-album-edit112 .trackpick112 label{display:grid;grid-template-columns:22px 44px minmax(0,1fr);align-items:center;gap:9px;min-height:54px;padding:5px 2px;border-bottom:1px solid rgba(255,255,255,.07)}.music-album-edit112 .trackpick112 img{width:44px;height:44px;border-radius:10px;object-fit:cover}.music-album-edit112 .trackpick112 strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:14px}.music-album-edit112 .footer1124{flex:0 0 auto;padding-top:7px;background:linear-gradient(to bottom,rgba(24,15,26,0),rgba(24,15,26,.992) 8px)}.music-album-edit112 .save112{width:100%;margin-top:0;min-height:42px;background:#fff;color:#251522}.music-album-edit112 .delete112{width:100%;margin-top:6px;min-height:38px;background:rgba(255,75,91,.12);color:#ff8e99;border:1px solid rgba(255,75,91,.28)}.music-album-edit112 .notice112{display:block;margin-top:4px;color:rgba(255,255,255,.48);font-size:9px;line-height:1.25;text-align:center}@media (max-height:740px){.music-album-edit112{inset:calc(48px + env(safe-area-inset-top)) 8px calc(54px + env(safe-area-inset-bottom));padding:10px 12px}.music-album-edit112 .art112{grid-template-columns:70px minmax(0,1fr)}.music-album-edit112 .art112 img{width:70px;height:70px}.music-album-edit112 .trackpick112{min-height:250px}.music-album-edit112 .notice112{display:none}}"+
