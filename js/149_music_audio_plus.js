...
(function(){
  ...
  function closeOverlayV109(){
    [PLUS_MENU_ID,ALBUM_SHEET_ID,"musicPlusMask109"].forEach(function(id){ var el=q(id); if(el) el.remove(); });
