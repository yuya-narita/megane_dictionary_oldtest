/* 137_recursion_bug_v09.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v0.9 / PHASE 4 + iOS ZOOM GUARD
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV09"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV09";
    st.textContent=`
  ...
  window.MEGANE_RECURSION_BUG={version:"v0.9-phase4-ios-zoom-guard",open:open,close:close};
})();
