/* 129_story_bug_v02.js
   SYNTAX FRONTIER INC.
   No.017 — STORY BUG v0.2
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      .sb-demon-wrap{
        ...
        animation:sbPixelBreathe 1.2s steps(2,end) infinite;
        filter:drop-shadow(8px 10px 0 rgba(0,0,0,.72));
      }
      @keyframes sbPixelBreathe{
      ...
      .sb-px.shadow{
        left:32px;right:32px;bottom:5px;height:16px;
        background:#120b18;
        box-shadow:
          -12px 0 0 #120b18,
          12px 0 0 #120b18,
      ...
      .sb-px.wing-l,.sb-px.wing-r{
        top:70px;width:56px;height:92px;background:#3d1858;
        box-shadow:
          inset 0 0 0 6px #21102e,
          0 0 0 4px #7a3f9a;
      }
      .sb-px.wing-l{
        left:4px;
        clip-path:polygon(100% 10%,68% 10%,68% 0,48% 18%,30% 18%,30% 34%,8% 34%,8% 54%,0 54%,18% 72%,18% 100%,52% 78%,70% 84%,82% 54%,100% 44%);
      }
      .sb-px.wing-r{
        right:4px;
        clip-path:polygon(0 10%,32% 10%,32% 0,52% 18%,70% 18%,70% 34%,92% 34%,92% 54%,100% 54%,82% 72%,82% 100%,48% 78%,30% 84%,18% 54%,0 44%);
      }
      .sb-px.cape{
        left:44px;top:78px;width:88px;height:112px;
        background:#5a1f72;
        box-shadow:
          inset 8px 0 0 #2a0f37,
          inset -8px 0 0 #2a0f37,
          0 0 0 5px #9d5ab8;
        clip-path:polygon(18% 0,82% 0,82% 12%,100% 12%,100% 100%,76% 86%,60% 100%,50% 90%,40% 100%,24% 86%,0 100%,0 12%,18% 12%);
      }
      .sb-px.body{
        left:56px;top:58px;width:64px;height:82px;
        background:#4b205e;
        box-shadow:
          inset 8px 0 0 #2a0f37,
          inset -8px 0 0 #2a0f37,
      ...
      .sb-px.armor{
        left:58px;top:103px;width:60px;height:58px;
        background:#b8772e;
        box-shadow:
          inset 0 8px 0 #efc86c,
          inset 8px 0 0 #7b441d,
          inset -8px 0 0 #7b441d,
          0 0 0 4px #f7df8f;
        clip-path:polygon(50% 0,100% 24%,84% 100%,50% 82%,16% 100%,0 24%);
      }
      .sb-px.head{
        left:60px;top:28px;width:56px;height:62px;
        background:#351542;
        box-shadow:
          inset 8px 0 0 #5c2b70,
          inset -8px 0 0 #1e0c27,
          0 0 0 5px #d6a95c;
      }
      .sb-px.horn-l,.sb-px.horn-r{
        top:8px;width:28px;height:48px;background:#d39b45;
        box-shadow:inset 0 8px 0 #ffe089;
      }
      .sb-px.horn-l{
        left:42px;
        clip-path:polygon(100% 100%,68% 100%,68% 78%,42% 78%,42% 54%,20% 54%,20% 30%,0 30%,0 0,34% 0,34% 18%,58% 18%,58% 42%,82% 42%,82% 66%,100% 66%);
      }
      .sb-px.horn-r{
        right:42px;
        clip-path:polygon(0 100%,32% 100%,32% 78%,58% 78%,58% 54%,80% 54%,80% 30%,100% 30%,100% 0,66% 0,66% 18%,42% 18%,42% 42%,18% 42%,18% 66%,0 66%);
      }
      .sb-px.crown{
        left:52px;top:0;width:72px;height:34px;
        background:#d99f38;
        box-shadow:
          inset 0 8px 0 #ffe277,
          inset 0 -6px 0 #8b4d16,
          0 0 0 4px #ffeb9b;
        clip-path:polygon(0 100%,0 50%,18% 50%,18% 18%,34% 54%,50% 0,66% 54%,82% 18%,82% 50%,100% 50%,100% 100%);
      }
      .sb-px.eye-l,.sb-px.eye-r{
        top:52px;width:12px;height:8px;background:#ff4040;
        box-shadow:0 0 0 3px #5d1010,0 0 10px #ff3131;
        animation:sbPixelBlink 3.4s steps(1,end) infinite;
      }
      .sb-px.eye-l{left:72px}
      .sb-px.eye-r{right:72px}
      @keyframes sbPixelBlink{
        0%,94%,100%{height:8px}
        95%,98%{height:3px}
      }
      .sb-px.mouth{
        left:78px;top:74px;width:20px;height:6px;background:#140817;
        box-shadow:0 4px 0 #6f355f;
      }
      .sb-px.gem{
        left:80px;top:120px;width:16px;height:16px;background:#69dcff;
        box-shadow:
          0 0 0 4px #f4ffff,
          0 0 0 8px #29759a,
          0 0 16px #4ddcff;
      ...
      .sb-px.hand-l,.sb-px.hand-r{
        top:112px;width:24px;height:34px;background:#6b2d77;
        box-shadow:0 0 0 4px #c98a48;
      }
      .sb-px.hand-l{left:38px}
      .sb-px.hand-r{right:38px}
      .sb-px.boot-l,.sb-px.boot-r{
        bottom:10px;width:34px;height:24px;background:#24102f;
        box-shadow:0 0 0 4px #7a3f92;
      }
      .sb-px.boot-l{left:48px}
      .sb-px.boot-r{right:48px}
      .sb-demon-name{
      ...
      <div class="sb-shell">
        ...
        <div class="sb-loading">
          ...
          <div class="sb-loading-panel">
            <div class="sb-rom">ROM 017 / STORY BUG / v0.2</div>
          ...
          <div class="sb-battle">
            <div class="sb-scene">
              ...
              <div class="sb-demon-wrap">
                <div class="sb-pixel-demon">
                  <span class="sb-px shadow"></span>
                  <span class="sb-px wing-l"></span>
                  <span class="sb-px wing-r"></span>
                  <span class="sb-px cape"></span>
                  <span class="sb-px body"></span>
                  <span class="sb-px armor"></span>
                  <span class="sb-px head"></span>
                  <span class="sb-px horn-l"></span>
                  <span class="sb-px horn-r"></span>
                  <span class="sb-px crown"></span>
                  <span class="sb-px eye-l"></span>
                  <span class="sb-px eye-r"></span>
                  <span class="sb-px mouth"></span>
                  <span class="sb-px gem"></span>
                  <span class="sb-px hand-l"></span>
                  <span class="sb-px hand-r"></span>
                  <span class="sb-px boot-l"></span>
                  <span class="sb-px boot-r"></span>
                </div>
              </div>
            </div>
