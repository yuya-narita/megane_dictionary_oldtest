...
(function(){
  ...
  var VERSION="v0.4a-phase1-ui-media";
  ...
  function ensureStyle(){
    if(document.getElementById("approvalBugStyleV04A"))return;
    var s=document.createElement("style");
    s.id="approvalBugStyleV04A";
    s.textContent=`
      ...
      #approvalBugRoot textarea{
        ...
        font:500 18px/1.6 inherit;padding:10px 2px 12px;overflow-y:auto
      }
