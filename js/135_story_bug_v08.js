/* 135_story_bug_v08.js
   SYNTAX FRONTIER INC.
   No.017 — STORY BUG v0.8
  ...
  function ensureStyle(){
    ...
    style.textContent=`
      ...
      .sb-log{
        ...
        background:#050505;
        padding:11px 13px;
        font:700 14px/1.55 ui-monospace,monospace;
      ...
      <div class="sb-shell">
        ...
        <div class="sb-loading">
          ...
          <div class="sb-loading-panel">
            <div class="sb-rom">ROM 017 / STORY BUG / v0.8</div>
