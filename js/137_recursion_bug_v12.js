/* 137_recursion_bug_v12.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v1.2 / PROGRESSION + DEV BUTTON FIX
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV12"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV12";
    st.textContent=`
  ...
  function open(){
    ...
    root.innerHTML=`<div class="rb-shell">
      <header class="rb-head"><span>SYNTAX FRONTIER INC. / BUG No.023</span><div class="rb-head-actions"><button type="button" class="rb-icon rb-dev-open" aria-label="Developer">D</button><button type="button" class="rb-icon rb-pause-btn" aria-label="一時停止">Ⅱ</button><button type="button" class="rb-icon rb-close" aria-label="閉じる">×</button></div></header>
      <main class="rb-main"><div class="rb-stage"><canvas class="rb-canvas"></canvas><div class="rb-scan"></div>
        ...
        <div class="rb-dev">
          ...
          <div class="rb-dev-note">OPEN: header long press / title 5 taps / keyboard F2</div>
        </div>
  ...
  window.MEGANE_RECURSION_BUG={version:"v1.2-progression-dev-button-fix",open:open,close:close};
})();
