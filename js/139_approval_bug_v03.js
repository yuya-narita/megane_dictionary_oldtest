...
(function(){
  ...
  var VERSION="v0.3-storage-rebuild";
  ...
  function ensureStyle(){
    if(document.getElementById("approvalBugStyleV03"))return;
    var s=document.createElement("style");
    s.id="approvalBugStyleV03";
    s.textContent=`
  ...
  function submitPost(){
    ...
    input.value="";
    var prev=$(".ab-image-preview");prev.src="";prev.classList.remove("show");
    $(".ab-image-chip").textContent="";
    updatePostButton();
    switchTab("home");
    save(true);
    later(function(){
