/* 137_recursion_bug_v16.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v1.6 / HEADER CONTROLS + DEV SCROLL FIX
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV16"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV16";
    st.textContent=`
  ...
  window.MEGANE_RECURSION_BUG={version:"v1.6-header-controls-dev-scroll-fix",open:open,close:close};
})();
