/* 137_recursion_bug_v17.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v1.7 / LARGE FIELD FIT FIX
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV17"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV17";
    st.textContent=`
  ...
  window.MEGANE_RECURSION_BUG={version:"v1.7-large-field-fit-fix",open:open,close:close};
})();
