/* 134_story_bug_v07.js
   SYNTAX FRONTIER INC.
   No.017 — STORY BUG v0.7
...
(function(){
      ...
      <div class="sb-shell">
        ...
        <div class="sb-loading">
          ...
          <div class="sb-loading-panel">
            <div class="sb-rom">ROM 017 / STORY BUG / v0.7</div>
  ...
  function showGameOver(){
    ...
    if(defeatCount===1){
      copy.textContent="勇者は　たおれた。\n\nRETRY";
    }else if(defeatCount===2){
      copy.textContent="BATTLE RESULT\n\nVICTORY CONDITION\nNOT FOUND.";
    }else if(defeatCount===3){
      talkUnlocked=true;
      copy.innerHTML='<span class="sb-system-update">SYSTEM UPDATE...</span><br><br>NEW COMMAND<br>UNLOCKED';
    }else{
      copy.textContent="勇者は　たおれた。\n\n会話は　まだ選べる。";
    }
  ...
  function finishDialogue(){
    ...
    copy.innerHTML=
      'CONTINUE CONVERSATION<br><br>'+
      'NO BATTLE<br>'+
      'ONLY STORY.<br><br>'+
      '<span class="sb-system-update">BUG No.017<br>STORY BUG FOUND.</span>';
