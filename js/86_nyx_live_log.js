...
(function(){
  ...
  function ensureStyle(){
    ...
    st.textContent = ''
      ...
      + '.nyx-sponsor-main{font-size:clamp(21px,5.6vw,36px);line-height:1.16;font-weight:950;letter-spacing:.045em;color:rgba(255,255,255,.97);margin:0 0 28px;white-space:nowrap;word-break:keep-all;overflow-wrap:normal;}'
      ...
      + '@media (max-width:480px){.nyx-live-log-sponsor{top:41%;width:94%;padding:22px 14px 20px}.nyx-sponsor-main{font-size:clamp(20px,5.8vw,23px);letter-spacing:.025em;white-space:nowrap;word-break:keep-all;overflow-wrap:normal;margin-bottom:26px}.nyx-sponsor-presented{margin-bottom:26px}.nyx-sponsor-logo{max-height:42px}.nyx-sponsor-org-logo{width:28px;height:28px;flex-basis:28px}.nyx-sponsor-orgs{font-size:13px}.nyx-sponsor-label{font-size:9px}}'
