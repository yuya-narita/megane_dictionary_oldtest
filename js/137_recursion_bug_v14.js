/* 137_recursion_bug_v14.js
   SYNTAX FRONTIER INC.
   BUG No.023 — RECURSION BUG
   ENDLESS STACK v1.4 / ROUTER LOAD FIX
...
(function(){
  ...
  function ensureStyle(){
    if(document.getElementById("recursionBugStyleV14"))return;
    var st=document.createElement("style");st.id="recursionBugStyleV14";
    st.textContent=`
  ...
  window.MEGANE_RECURSION_BUG={version:"v1.4-router-load-fix",open:open,close:close};
})();
